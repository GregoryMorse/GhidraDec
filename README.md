...
RetDec v5.0: https://github.com/avast/retdec config, common, serdes, and utils libraries:
`ghidradec.targets.json`
...
Legacy Visual Studio project reference only; the CMake dependency build does not
compile RetDec's binary-path utility that requires it.
