...
def main() -> int:
    ...
    parser.add_argument("--platform", default="", help="CMake generator platform, for example Win32 or x64.")
    parser.add_argument("--osx-arch", default="", help="CMAKE_OSX_ARCHITECTURES value, for example x86_64 or arm64.")
